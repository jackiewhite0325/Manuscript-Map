...
//  PRO UPGRADE MODAL
// ============================================================
// PLACEHOLDER — real pricing not yet decided. Confirm before this ships publicly.
...
function initRouter() {
  ...
  const valid = ["dashboard", "checklist", "metadata", "questionnaire", "assets", "arcs", "reviews", "distribution", "sales", "ads"].includes(hash)
    ? hash
    : "dashboard";
  showPage(valid);
  ...
  window.addEventListener("hashchange", () => {
    ...
    if (["dashboard", "checklist", "metadata", "questionnaire", "assets", "arcs", "reviews", "distribution", "sales", "ads"].includes(p)) showPage(p);
  });
}
